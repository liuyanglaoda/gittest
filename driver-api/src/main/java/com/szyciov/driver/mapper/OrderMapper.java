...
import com.szyciov.driver.param.*;
...
public interface OrderMapper {
    ...
    int addOrgOrderfile(@Param("list") List<OrgOrderfileParam> list, @Param("cat") int cat);
    int deleteOrgOrderfile(DeleteOrgOrderfileParam param);
    List<String> getCertificateList(@Param("orderno") String orderno, @Param("cat") int cat);
}
