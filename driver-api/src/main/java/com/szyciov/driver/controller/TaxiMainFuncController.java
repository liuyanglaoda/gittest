...
/**
  ...
  */
@RestController("TaxiMainFuncController")
@RequestMapping("/")
@Api(value = "用车审批对外接口",description = " ")
@Slf4j
public class TaxiMainFuncController extends ApiExceptionHandle{
	...
	@ApiOperation(value = "出租车一键报警", notes = "出租车一键报警")
	...
	@ApiOperation(value = "校验银行卡信息", notes = "校验银行卡信息")
	...
	@ApiOperation(value = "进入提现前的检核", notes = "进入提现前的检核")
	...
	@ApiOperation(value = "出租车我的贡献", notes = "出租车我的贡献")
	...
	@ApiOperation(value = "添加银行卡(已废弃)", notes = "添加银行卡(已废弃)")
	...
	@ApiOperation(value = "出租车获取消息", notes = "出租车获取消息")
	...
	@ApiOperation(value = "出租车重置密码(目前只能重置提现密码)", notes = "出租车重置密码(目前只能重置提现密码)")
