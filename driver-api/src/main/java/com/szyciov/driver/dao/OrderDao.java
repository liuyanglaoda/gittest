...
public class OrderDao {
	...
	/**
	 * 通过ID获取订单信息
	 * @param param 需要OrderProp和OrderNO
	 * @return {@link OrderInfoDetail}
     ...
     * @return 影响条数
     */
    public int addOrgOrderfile(List<OrgOrderfileParam> list, int cat) {
        return this.mapper.addOrgOrderfile(list, cat);
    }
     ...
     * @return 影响条数
     */
    public int deleteOrgOrderfile(DeleteOrgOrderfileParam param){
        return this.mapper.deleteOrgOrderfile(param);
    }
     ...
     * @return 凭证URL
     */
    public List<String> getCertificateList(String orderno, int cat){
        return this.mapper.getCertificateList(orderno, cat);
    }
