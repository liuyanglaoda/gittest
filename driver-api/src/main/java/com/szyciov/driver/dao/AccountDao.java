...
public class AccountDao {
	 ...
	 */
	public PubDriver getPubDriverFactModel(PubDriver driver){
		return mapper.getPubDriverFactModel(driver);
	}
	 ...
	 * @return
	 */
	public Map<String, String> peopleVehicleRalation(String id){
		return mapper.peopleVehicleRalation(id);
	}
}
